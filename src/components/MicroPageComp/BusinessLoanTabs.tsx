...
import { BusinessKeyEligibilityCriteria, BusinessLoanBanner, DownArrow, FillYourBasicDetails } from "@/assets";
import { ROUTES } from "@/utils/Constant";
import {
  business_eligibilitydocument_faq,
  business_emicalculator_faq,
  business_howtoapply_faq,
  business_interestrate_faq,
  business_overview_faq,
} from "@/utils/F&Q";
import { moveToApplyLoan } from "@/utils/helper";
import { updateMetaTags } from "@/utils/helper.client";
import {
  BusinessApplyForBusinessData,
  BusinessDocumentationChecklistData,
  BusinessDocumentationWithRatnaafinData,
  BusinessEligibilityData,
  BusinessEMICalculatorData,
  BusinessInterestRateFactors,
  BusinessInterestRateRangeData,
  BusinessKeyFeaturesData,
  BusinessLoanApplicationProcessData,
  BusinessLoanRateOptimizationData,
  BusinessLoanTypesData,
  BusinessOverviewData,
  BusinessStabilityRequirementsData,
  BusinessSwiper_Data,
  BusinessTimelineData,
  BusinessTipsData,
  BusinessTrustedLendingData,
  BusinessWhyChooseUsData,
...
const TAB_CONFIG = [
  {
    ...
    slug: "overview",
    heroData: {
      title: "Business Loans up to ₹75 Lakh for Your Growing Business",
      subTitle: "End to End Disbursement within 48 hours from file login. Flexible tenure up to 36 months. Start your growth journey with Ratnaafin.",
    },
  },
  {
    ...
    slug: "interest-rates",
    heroData: {
      title: "Business Loan Interest Rate & Charges",
      subTitle:
        "Transparent pricing is the foundation of trust. At Ratnaafin, there are no hidden charges. Just clear, competitive rates designed for MSME growth.",
    },
  },
  {
    ...
    heroData: {
      ...
      subTitle:
        "We keep eligibility criteria straightforward because we believe in supporting real, growing businesses. If your business is profitable, established, and has clean banking practices, you likely qualify.",
    },
  },
  {
    label: "How To Apply",
    slug: "how-to-apply",
    heroData: {
      title: "How to Apply for an Instant Business Loan?",
      subTitle:
        "Applying for a Ratnaafin business loan is simple, transparent, and mostly digital. From application to approval; it takes just a few days. Here’s how it works.",
    },
  },
  {
    ...
    heroData: {
      ...
      subTitle:
        "Before you commit to a loan, understand exactly what you’ll pay every month. Our EMI calculator helps you plan repayment comfortably and choose the right loan amount for your business cash flow.",
    },
  },
];
...
const OverviewProp = {
  ...
  cards: BusinessOverviewData,
};
const KeyFeaturesProp = {
  header: { title: "Key Features" },
  cards: BusinessKeyFeaturesData,
  link: { link: ROUTES.client.termsAndConditions, text: `*T&C Apply` },
};
const loanTypesProp = {
  header: { title: "Types of Business Loan", description: "Pick the right loan structure for your business needs." },
  cards: BusinessLoanTypesData,
};
const interestRateFactorsProp = {
  header: { title: "Factors Influencing Interest Rate", description: "Your final rate depends on four key factors we assess during the application process:" },
  cards: BusinessInterestRateFactors,
};
const BusinessInterestRateRangeProp = {
  cards: BusinessInterestRateRangeData,
};
const BusinessLoanRateOptimizationProp = {
  header: {
    title: "How to Lower Business Loan Rate",
  },
  cards: BusinessLoanRateOptimizationData,
};
const whyChooseUsProp = {
  header: { title: "Why Our Pricing Works for MSMEs" },
  cards: BusinessWhyChooseUsData,
};
const SwiperDataProp = {
  header: {
    title: "Ideal For",
    description: "Whether you're looking to grow, manage cash flow, or scale operations, we have a solution. MSMEs which are looking forward to:",
  },
  cards: BusinessSwiper_Data,
};
const ApplyForBusinessProp = {
  header: {
    title: "Who Can Apply for Business Loan?",
  },
  cards: BusinessApplyForBusinessData,
};
const DocumentationWithRatnaafinProp = {
  header: {
    title: "Why Minimum Documentation with Ratnaafin?",
  },
  cards: BusinessDocumentationWithRatnaafinData,
};
const StabilityRequirementsProp = {
  header: {
    title: "Income and Stability Requirements",
  },
  cards: BusinessStabilityRequirementsData,
};
const EMICalculatorProp = {
  header: {
    title: "Why should you use an EMI calculator before applying for a Business Loan?",
  },
  cards: BusinessEMICalculatorData,
};
const eligibilityProp = {
  header: {
    title: "Key Eligibility Criteria",
  },
  image: BusinessKeyEligibilityCriteria,
  cards: BusinessEligibilityData,
};
const DocumentationChecklistProp = {
  header: {
    title: "Documentation Checklist",
  },
  cards: BusinessDocumentationChecklistData,
};
const LoanEmiProcessProp = {
  header: {
    title: "How to Use the Business Loan EMI Calculator",
  },
  cards: BusinessTimelineData,
};
const tipsProp = {
  header: {
    title: "Tips to Improve Approval Chances",
  },
  cards: BusinessTipsData,
};
const LoanApplicationProcessProp = {
  header: {
    title: "Business Loan Application Process",
  },
  cards: BusinessLoanApplicationProcessData,
  image: FillYourBasicDetails,
};
...
export default function BusinessLoanTabs({ data }) {
  ...
  const handleTabChange = (index: number) => {
    ...
    // Update meta tags
    updateMetaTags(slug, "businessLoan");
    ...
    if (tabContainerRef.current) {
      requestAnimationFrame(() => {
        setTimeout(() => {
          if (tabContainerRef.current) {
            const HEADER_OFFSET = isMobile ? 112 : 128;
    ...
    <>
      <div className="bg-gradient-to-l lg:bg-gradient-to-r from-primary-400 to-secondary-600 pt-10 grid lg:grid-cols-5 gap-4">
        <div className="lg:col-span-3 order-2">
          <Image fetchPriority="high" loading="eager" priority={true} src={BusinessLoanBanner} alt="business loan, business loan mumbai" />
        </div>
        <div className="lg:col-span-2 lg:order-2 container mx-auto 2xl:px-8 px-4">
          ...
          {/* <div className="flex flex-col gap-4 xs:gap-8 h-full justify-center xl:-mt-6 xl:mr-20 2xl:mr-[183px]">
            <div className="flex flex-col gap-2 text-white">
              <h2 className="text-xl md:text-3xl xl:text-4xl font-bold">Aap Business sambhalo, Loan hum sambhal Lenge</h2>
              <h1>Power your growth with a Business Loan</h1>
            </div>
            <button
              onClick={() => moveToApplyLoan("apply-now")}
              className="bg-white hover:bg-primary-400 w-fit xs:text-base text-xs text-black hover:text-white transition-all px-4 py-2 rounded-full"
            >
              Apply Now Business loan
            </button>
          </div> */}
        </div>
      </div>
      ...
      <Box className="w-full flex flex-col gap-4" ref={tabContainerRef}>
        ...
        <TabPanel value={value} index={0}>
          <div className="flex flex-col gap-6 md:gap-10">
            ...
            <div className="bg-senarylight-50">
              <InfoSection data={loanTypesProp} />
            </div>
            <SwiperSection data={SwiperDataProp} />
            <InfoSection data={KeyFeaturesProp} columns={5} />
            <TrustedLending title={BusinessTrustedLendingData.title} />
            <div className="container mx-auto flex flex-col gap-12 2xl:px-8 px-4">
              <Faq payload={business_overview_faq} />
            </div>
          </div>
        </TabPanel>
        <TabPanel value={value} index={1}>
          <div className="flex flex-col gap-6 md:gap-10">
            <InterestRateRange data={BusinessInterestRateRangeProp} />
            <div className="bg-senarylight-50">
              <InfoSection data={whyChooseUsProp} columns={3} />
            </div>
            <InfoSection data={interestRateFactorsProp} />
            <div className="flex flex-col gap-6 md:gap-10 !w-full !max-w-full" ref={sectionRef}>
              <LoanRateOptimization ref={sectionRef} data={BusinessLoanRateOptimizationProp} />
              <div className="container mx-auto flex flex-col gap-12 2xl:px-8 px-4">
                <Faq payload={business_interestrate_faq} />
              </div>
            </div>
          </div>
        </TabPanel>
        <TabPanel value={value} index={2}>
          <div className="flex flex-col gap-6 md:gap-10">
            ...
            <div className="bg-senarylight-50">
              <InfoSection data={DocumentationWithRatnaafinProp} columns={3} />
            </div>
            <div className="container mx-auto flex flex-col gap-12 2xl:px-8 px-4">
              <Faq payload={business_eligibilitydocument_faq} />
            </div>
          </div>
        </TabPanel>
        <TabPanel value={value} index={3}>
          <div className="flex flex-col gap-6 md:gap-10">
            ...
            <div className="container mx-auto flex flex-col gap-12 2xl:px-8 px-4">
              <Faq payload={business_howtoapply_faq} />
            </div>
          </div>
        </TabPanel>
        <TabPanel value={value} index={4}>
          <div className="flex flex-col gap-6 md:gap-10">
            ...
            <div className="contaxs:containeriner mx-auto flex flex-col gap-12 2xl:px-8 px-4">
              <Faq payload={business_emicalculator_faq} />
            </div>
          </div>
        </TabPanel>
      </Box>
