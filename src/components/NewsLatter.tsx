...
import { NewsLatterImage } from "@/assets";
...
function NewsLatter({ title, description, button }) {
  const dispatch = useAppDispatch();

  return (
    <div className="grid lg:grid-cols-2 lg:bg-gradient-to-r bg-gradient-to-t from-secondary-600 lg:via-primary-400 to-primary-400 rounded-2xl">
      <div className="flex flex-col gap-8 justify-center p-5 sm:p-10 lg:p-20">
      ...
      <div className="relative">
        <Image
          loading="lazy"
          src={NewsLatterImage.src}
          width={800}
          height={500}
          alt=""
          className="lg:rounded-r-2xl rounded-b-2xl w-full h-full object-cover object-center"
        />
        <div className="absolute inset-0 h-full w-full lg:bg-gradient-to-r bg-gradient-to-b lg:from-primary-400 xs:from-[#139581] from-[#119187] via-primary-400/20 to-primary-400/5 pointer-events-none"></div>
      </div>
      <RequestCallbackForm />
    </div>
  );
