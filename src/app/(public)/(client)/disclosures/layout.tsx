...
const metaDataConstant = {
  title: "Disclosures – Regulatory Information| Ratnaafin",
  description: "Explore Ratnaafin’s official disclosures and compliance policies. Stay informed with transparent NBFC practices.",
};
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: metaDataConstant.title,
    description: metaDataConstant.description,
    url: `${process.env.NEXT_PUBLIC_FRONTEND_URL}${ROUTES.client.disclosures}`,
    siteName: "Ratnaafin",
    images: [
      {
