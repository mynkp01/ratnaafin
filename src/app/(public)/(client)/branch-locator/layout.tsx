...
const metaDataConstant = {
  title: "Find a Ratnaafin Branch Near You",
  description:
    "Use Ratnaafin’s Branch Locator to find the nearest NBFC branch in your city. Visit us for expert financial solutions and personalized assistance across India.",
};
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: metaDataConstant.title,
    description: metaDataConstant.description,
    url: `${process.env.NEXT_PUBLIC_FRONTEND_URL}${ROUTES.client.branchLocator}`,
    siteName: "Ratnaafin",
    images: [
      {
