...
const metaDataConstant = {
  title: "Residential Solar Loan in India | Easy Solar Financing - Ratnaafin",
  description: "Switch to clean energy with Ratnaafin’s rooftop solar loans. Enjoy low interest rates, quick approval, and flexible EMI options",
};
export const metadata: Metadata = {
  ...
  openGraph: {
    title: metaDataConstant.title,
    description: metaDataConstant.description,
    url: `${process.env.NEXT_PUBLIC_FRONTEND_URL}${ROUTES.product.residentialSolarLoan}`,
    siteName: "Ratnaafin",
    images: [
      {
...
export default function Layout({ children }) {
  return (
    <>
      <FAQJsonLd questions={generateSchema(residential_solar_loan_faq.data || [])} />
      {children};
    </>
  );
}
