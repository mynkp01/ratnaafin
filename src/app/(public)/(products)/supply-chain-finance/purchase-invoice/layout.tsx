...
const metaDataConstant = {
  title: "Purchase Invoice Financing starting at 1.2 % | Ratnaafin",
  description:
    "Enable smooth cash flow and stronger supplier relationships with Ratnaafin’s collateral-free Purchase Invoice Financing. Quick disbursal, flexible terms - growth Possible Hai.",
};
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: metaDataConstant.title,
    description: metaDataConstant.description,
    url: `${process.env.NEXT_PUBLIC_FRONTEND_URL}${ROUTES.product.scfPurchaseInvoice}`,
    siteName: "Ratnaafin",
    images: [
      {
