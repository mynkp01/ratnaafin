...
const MachineryLoanTabs = dynamic(() => import("@/components/MicroPageComp/MachineryLoanTabs"), {
  ssr: false,
});
...
const heroData = {
  ...
  description: "Finance new equipment, upgrade production capacity, and scale operations with quick approvals. Tailored solutions for industrial growth.",
};
