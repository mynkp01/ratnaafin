...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const metaData = MICRO_PAGES_META_DATA.businessLoan[slug] || MICRO_PAGES_META_DATA.businessLoan.overview;

  const url = `${process.env.NEXT_PUBLIC_FRONTEND_URL}/business-loan/${slug}`;
...
const FAQSData = {
  overview: business_overview_faq.data,
  "interest-rates": business_interestrate_faq.data,
  "eligibility-document": business_eligibilitydocument_faq.data,
  "how-to-apply": business_howtoapply_faq.data,
  "emi-calculator": business_emicalculator_faq.data,
};
