...
const metaDataConstant = {
  title: "Apply for MSME Loan Online 2025 | Ratnaafin",
  description: "Apply for a MSME loans with competitive interest rates, quick approval, and minimum documentation.",
};
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: metaDataConstant.title,
    description: metaDataConstant.description,
    url: `${process.env.NEXT_PUBLIC_FRONTEND_URL}/msme`,
    siteName: "Ratnaafin",
    images: [
      {
